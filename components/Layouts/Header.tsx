        ...
        <header className={`sticky top-0 z-50 bg-black/10 duration-300 ${props.className} `}>
            <div className="!bg-green-500 container">
                <div className="flex items-center justify-between py-5 lg:py-0">
                    <Link href="/">
                        <img src="/assets/images/dpa_logo.png" alt="plurk" className="h-10 w-full " />
                    </Link>
                            ...
                            <ul onClick={() => toggleMenu()}>
                                ...
                                <li className="group relative" onClick={(e) => e.stopPropagation()}>
                                    <Link
                                        href="#"
                                        className={
                                            router.pathname === '/crypto' || router.pathname === '/modern-saas' || router.pathname === '/real-estate'
                                                ? 'active'
                                                : ''
                                        }
                                    >
                                    ...
                                    <div className="submenu" onClick={() => toggleMenu()}>
                                        <Link href="/hamoda" className={router.pathname === '/hamoda' ? 'active' : ''}>
                                            File a Complaint
                                        </Link>
                                        <Link href="/modern-saas" className={`${router.pathname === '/modern-saas' ? 'active' : ''} bg-green-600`}>
                                            {' '}
