...
const Aboutus = () => {
    ...
    return (
        <div>
            <Head>
                <title>About Us | DPA Data Protection Authority</title>
            </Head>
            ...
            <section className="relative pt-14 lg:pb-48 lg:pt-[100px]">
                ...
                <div className="bottom-0 ltr:right-0 rtl:left-0 lg:absolute" data-aos={isRtl ? 'fade-right' : 'fade-left'} data-aos-duration="1000">
                    <img src="/assets/images/aboutbg.png" alt="About" className="rtl:rotate-y-180 ml-72" />
                </div>
            </section>
                    ...
                    >
                        <div>
                            <span>
                                ...
                                <GiInjustice className='text-primary text-4xl'/>
                        ...
                        <div>
                            <span>
                                ...
                                <IoNewspaper className='text-primary text-4xl'/>
                            </span>
                        ...
                        <div>
                            <span>
                                ...
                                <BsFillPrinterFill className='text-primary text-4xl'/>
                            </span>
                        ...
                        <div>
                            <span>
                                ...
                                <GoGoal  className='text-secondary text-4xl'/>
                            </span>
                        ...
                        <div>
                            <span>
                                ...
                                <BsDatabase className='text-secondary text-4xl'/>
                            </span>
                        ...
                        <div>
                            <span>
                                ...
                                <FaPenNib className='text-secondary text-4xl'/>
                            </span>
                            <h5 className="mt-5 text-lg font-extrabold text-black dark:text-white">Fairness and Accountability</h5>
                            <p className="mt-2.5 text-[15px] font-semibold">Process personal data with fairness and accountability, adhering to privacy principles.</p>
                        </div>
                    </div>
                </div>
            </section>
